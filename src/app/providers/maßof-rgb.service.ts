...
export class MaßOfRGBService {
  ...
  getPseudoMaßRGB_opposed(iMaß: number, iMaß_sup: number): RGBMenge {
    var pseudomaß: number = iMaß * iMaß_sup + 0;
    ...
    if(pseudomaß == 0) {
      ...
      // throw new Error("Maß wurde falsch gesetzt oder verrechnet! rest pseudoMaß: " + pseudomaß.toString() );
    }
  }
